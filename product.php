				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<p>One of the grat laptop available for commercial use.</p>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab2" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12">
											<p>The quality of the product is great.</p>
										</div>
									</div>
								</div>
								<!-- /tab2  -->
												...
												<ul class="reviews">
													<li>
														...
														<div class="review-body">
															<p>One of the best product available on the market</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Dibya Meher</h5>
															<p class="date">14 APR 2021, 08:00 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>Awesom product thank.</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Govind</h5>
															<p class="date">14 APR 2021, 08:00 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
                        ...
                        echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>&#8377 990.00</del></h4>
										<div class='product-rating'>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
